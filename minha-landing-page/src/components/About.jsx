...
const About = () => {
  return (
    <section id="about" className="py-16 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-900 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-6 md:px-12">
        {/* Título da Seção */}
        <motion.h2
          className="text-3xl md:text-4xl font-bold text-center text-white dark:text-gray-100 mb-6"
        ...
        {/* Conteúdo */}
        <motion.div
          className="text-white dark:text-gray-200 md:text-lg leading-relaxed"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <div className="text-center mt-6">
            <motion.a
              ...
              download
              className="inline-flex items-center bg-blue-300 hover:bg-blue-400 text-white px-6 py-3 rounded-full transition-colors duration-300"
