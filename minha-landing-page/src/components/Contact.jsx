    ...
    <section id="contact" className="py-20 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-around">
          ...
          <motion.form
            className="w-full md:w-1/2 bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md"
          ...
          >
            ...
            <input
              ...
              id="name"
              name="name"
              className="w-full p-2 mb-4 border border-gray-300 dark:border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-600 dark:text-white"
              required
            />
